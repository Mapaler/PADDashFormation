...
let localTranslating = {
	...
	skill_parse: {
		...
		cond: {
			...
			enemy_attr: tp`When enemy's attribute is ${'attrs'}`,
		},
		position: {
...
const official_badge_sorting = [ //20是没有启用的全属性徽章，现在也不在游戏内显示了
	 ...
	 45, 46, 47, 48, 24, 79, 25, 26, 53, 27,
	 28, 29, 30, 65, 31,103, 15, 16, 70, 32, 33, 76,
	 34, 35, 75, 36, 77, 37, 38, 62, 39, 40, 78, 49,
	 50, 80, 51, 52, 83, 54, 55, 56, 57, 58, 59,
	 60, 61, 63, 64, 66, 67, 68, 69,
	 71, 72, 73, 74, 81, 82, 84, 85, 86, 87, 88, 89, 90,
...
const official_awoken_sorting = [
	 21, 43, 61,144, 54,140, 70,148, 49,
	 56,107,111, 52, 55, 68, 69,136, 28,
	141, 48, 27, 78, 60,126, 59, 45, 50,
	 53,109, 96,110,108, 79, 80, 81, 51,
	106, 57, 58, 82, 62,112,113,114, 97,
	143,133,134,135,137, 29,  9, 20, 44,
