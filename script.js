...
Formation.pdcLatentMap = [
	...
	{pdf:36,pdc:32}, //大暗盾
	{pdf:37,pdc:33}, //6色破无效
	{pdf:37,pdc:45}, //6色破无效 ×2
	{pdf:38,pdc:34}, //3色破属吸
	{pdf:38,pdc:46}, //3色破属吸 ×2
	{pdf:39,pdc:40}, //C珠破吸
	{pdf:39,pdc:50}, //C珠破吸 ×2
	{pdf:40,pdc:39}, //心横解转转
	{pdf:40,pdc:49}, //心横解转转 ×2
	{pdf:41,pdc:38}, //U解禁消
	{pdf:41,pdc:48}, //U解禁消 ×2
	{pdf:42,pdc:41}, //伤害上限×4
	{pdf:43,pdc:42}, //HP++
	{pdf:44,pdc:43}, //攻击++
	{pdf:45,pdc:44}, //回复++
	{pdf:46,pdc:51}, //心追解云封
	{pdf:46,pdc:52}, //心追解云封 ×2
	{pdf:47,pdc:53}, //心L大SB
	{pdf:47,pdc:54}, //心L大SB ×2
	{pdf:48,pdc:55}, //L解禁武器
	{pdf:48,pdc:56}, //L解禁武器 ×2
	{pdf:49,pdc:57}, //伤害上限×8
	{pdf:50,pdc:60}, //十字追部位
];
...
function highlightAwokenMember(event, teamIndex) {
	if (teamIndex<0) return; //没有目标队伍就退出
...
function highlightAwokenMemberForIcon(event) {
	...
	const teamIndex = teamBigBoxs.findIndex(box=>box.contains(this));
	highlightAwokenMember.call(this, event, teamIndex);
}
