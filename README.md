...
[下载压缩包](https://github.com/Mapaler/PADDashFormation/archive/master.zip)后使用浏览器打开`index.html`。火狐68.0及以后需要在`about:config`设定`privacy.file_unique_origin`为`false`。  
